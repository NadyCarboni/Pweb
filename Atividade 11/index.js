...
document.write(
  "O retângulo tem as medidas x = " +
    retangulo.x +
    " y = " +
    retangulo.y +
    " e sua área é igual a: " +
    retangulo.calcArea() +
    "\n\n\n"
);
...
var texto =
  "Conta poupança:<br>Nome: " +
  contaPoup.getnomeCorrent() +
  "<br> Banco: " +
  contaPoup.getBanco() +
  "<br>Número conta: " +
  contaPoup.getNConta() +
  ...
  contaPoup.getJuros() +
  "<br>Data Vencimento: " +
  contaPoup.getDataVenc() +
  "<br><br><br>";

var texto2 =
  "Conta Corrente:<br>Nome: " +
  contaCor.getnomeCorrent() +
  "<br> Banco: " +
  contaCor.getBanco() +
  "<br>Número conta: " +
  contaCor.getNConta() +
